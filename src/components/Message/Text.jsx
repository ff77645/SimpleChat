...
export default function Text({data,align}){
    ...
    return (
        <div className={`mx-3 mt-3 flex ${align === 'right' ? 'flex-row-reverse' : 'flex-row'} flex-nowrap gap-2 p-2`}>
            ...
            <div className={`flex-1  ${align === 'right' && 'text-right'}`}>
                ...
                <div className={`bg-white rounded p-2 text-black mt-2 inline-block`}>
                    {data.text}
                </div>
            </div>
        </div>
